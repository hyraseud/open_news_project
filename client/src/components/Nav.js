...
const Nav = () => {
    ...
    const handleOpenNewsClick = () => {
        navigate("/");
    };

    return (
        <nav className="navbar">
            <h2 onClick={handleOpenNewsClick}>OpenNews</h2>
            <button onClick={handleBreakingNewsClick} className="navbar-button">
                Breaking News
            </button>
            <div
            ...
            >
                ...
                {showDropdown && (
                    <div className="dropdown">
                        ...
                        <button
                            onClick={() => handleSelect("north-america")}
                            className="dropdown-item"
                        >
                            North America
                        </button>
                        <button
                            onClick={() => handleSelect("south-america")}
                            className="dropdown-item"
                        >
                            South America
                        </button>
                        ...
                        <button
                            onClick={() => handleSelect("antarctica")}
                            className="dropdown-item"
                        >
                            Antarctica
                        </button>
            ...
            <button onClick={() => navigate("/media")} className="navbar-button">
                Media Page
            </button>
